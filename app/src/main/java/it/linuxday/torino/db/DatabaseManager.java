...
public class DatabaseManager {
	...
	public static final String ACTION_SCHEDULE_REFRESHED = "it.linuxday.torino.action.SCHEDULE_REFRESHED";
	public static final String ACTION_CONFERENCE_UPDATED = "it.linuxday.torino.action.CONFERENCE_UPDATED";
	public static final String ACTION_ADD_BOOKMARK = "it.linuxday.torino.action.ADD_BOOKMARK";
	public static final String EXTRA_EVENT_ID = "event_id";
	public static final String EXTRA_EVENT_START_TIME = "event_start";
	public static final String ACTION_REMOVE_BOOKMARKS = "it.linuxday.torino.action.REMOVE_BOOKMARKS";
	public static final String EXTRA_EVENT_IDS = "event_ids";

	private static final Uri URI_TRACKS = Uri.parse("sqlite://it.linuxday.torino/tracks");
	private static final Uri URI_EVENTS = Uri.parse("sqlite://it.linuxday.torino/events");
