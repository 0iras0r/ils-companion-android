...
package it.linuxday.torino.services;
...
import it.linuxday.torino.activities.EventDetailsActivity;
import it.linuxday.torino.activities.MainActivity;
import it.linuxday.torino.activities.RoomImageDialogActivity;
import it.linuxday.torino.db.DatabaseManager;
import it.linuxday.torino.fragments.SettingsFragment;
import it.linuxday.torino.model.Event;
import it.linuxday.torino.receivers.AlarmReceiver;
...
public class AlarmIntentService extends IntentService {
	...
	public static final String ACTION_UPDATE_ALARMS = "it.linuxday.torino.action.UPDATE_ALARMS";
	public static final String EXTRA_WITH_WAKE_LOCK = "with_wake_lock";
	public static final String ACTION_DISABLE_ALARMS = "it.linuxday.torino.action.DISABLE_ALARMS";
