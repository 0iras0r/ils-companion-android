...
public class DatabaseManager {
	...
	public static final String ACTION_REMOVE_BOOKMARKS = "it.reyboz.conferencecompanion.action.REMOVE_BOOKMARKS";
	public static final String EXTRA_EVENT_IDS = "event_ids";

	private static final Uri URI_TRACKS = Uri.parse("sqlite://it.reyboz.conferencecompanion/tracks");
	private static final Uri URI_EVENTS = Uri.parse("sqlite://it.reyboz.conferencecompanion/events");
