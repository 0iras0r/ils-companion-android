...
package it.reyboz.conferencecompanion.services;
...
import it.reyboz.conferencecompanion.activities.MainActivity;
import it.reyboz.conferencecompanion.activities.RoomImageDialogActivity;
import it.reyboz.conferencecompanion.db.DatabaseManager;
import it.reyboz.conferencecompanion.fragments.SettingsFragment;
import it.reyboz.conferencecompanion.model.Event;
import it.reyboz.conferencecompanion.receivers.AlarmReceiver;
...
public class AlarmIntentService extends IntentService {
	...
	public static final String ACTION_UPDATE_ALARMS = "it.reyboz.conferencecompanion.action.UPDATE_ALARMS";
	public static final String EXTRA_WITH_WAKE_LOCK = "with_wake_lock";
	public static final String ACTION_DISABLE_ALARMS = "it.reyboz.conferencecompanion.action.DISABLE_ALARMS";
			...
			case AlarmReceiver.ACTION_NOTIFY_EVENT: {
				...
				if (event != null) {
					...
					NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
							.setSmallIcon(R.drawable.ic_stat_conferencecompanion)
					...
					// Blink the LED if enabled in the options
